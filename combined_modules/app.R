...
source("support_scripts/20190929_dsfworld_modeling.R")
...
server <- function(session, input, output) {
    ...
    ##### begin 4_analyze applet server, which includes most (all?) of the plotting server features
    # # plotting server  ---------------------------    
