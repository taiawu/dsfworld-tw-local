...
sample_data <- by_component_s1  %>% unnest(data) 

low_T <- min(sample_data$Temperature)
high_T <- max(sample_data$Temperature)
n_meas <- sample_data$Temperature %>% unique() %>% length()
